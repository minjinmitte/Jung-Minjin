...
Pd(c,a,b.Ne);if(d)a:{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||l;d?b.ba&&b.ba.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Nb&&b.Nb.call(f,a,e)}},b.method,h,b.headers,b.responseType,b.withCredentials);
...
g.Va=function(a){for(var b=Oe(this).values,c=0;c<b.length;c++)if(b[c]==a)return!0;return!1};
...
Vf.prototype.tb=function(a){for(var b=0;b<this.b.length;b++)if(this.b[b]==a){this.b.splice(b,1);a.target.removeEventListener(a.name,a.zb);break}};
...
vg(a,b,c,function(a){if(!f)if(f=!0,e&&I(e),a)d.ba&&d.ba(a);else if(d.onError)d.onError()})}
...
;var Lh={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function Mh(a,b){D.call(this);this.o=this.j=a;this.V=b;this.u=!1;this.f={};this.qa=this.U=null;this.Z=new F;Ub(this,ma(E,this.Z));this.i={};this.D=this.Ga=this.g=this.Ta=this.b=null;this.ia=!1;this.F=this.l=this.K=this.L=null;this.Ha={};this.Uc=["onReady"];this.ka=new Vf(this);Ub(this,ma(E,this.ka));this.yb=null;this.Xb=NaN;this.la={};Nh(this);this.na("onDetailedError",w(this.Ed,this));this.na("onTabOrderChange",w(this.Zc,this));this.na("onTabAnnounce",w(this.Yb,this));this.na("WATCH_LATER_VIDEO_ADDED",
w(this.Fd,this));this.na("WATCH_LATER_VIDEO_REMOVED",w(this.Gd,this));kf||(this.na("onMouseWheelCapture",w(this.Bd,this)),this.na("onMouseWheelRelease",w(this.Cd,this)));this.na("onAdAnnounce",w(this.Yb,this));this.H=new Vf(this);Ub(this,ma(E,this.H));this.Sa=!1;this.Ra=null}
...
function Ph(a,b){a.Ta=b;a.b=b.clone();a.g=a.b.attrs.id||a.g;"video-player"==a.g&&(a.g=a.V,a.b.attrs.id=a.V);a.o.id==a.g&&(a.g+="-player",a.b.attrs.id=a.g);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.V;a.Ga||(a.Ga=Sh(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.o.style.width=cf(Number(c)||c,!0));if(c=a.b.attrs.height)a.o.style.height=cf(Number(c)||c,!0)}
...
g.pe=function(){if(!this.ia){var a=Wh(this);a&&"html5"==Xh(this)?(this.D="html5",this.u||this.Ma()):(Yh(this),this.D="html5",a&&this.K?(this.j.appendChild(this.K),this.Ma()):(this.b.loaded=!0,this.L=w(function(){var a=this.j,c=this.b.clone();r("yt.player.Application.create")(a,c);this.Ma()},this),this.ia=!0,a?this.L():(qc(this.b.assets.js,this.L),If(this.b.assets.css))))}};
g.oe=function(){var a=this.b.clone();if(!this.l){var b=Vh(this);b&&(this.l=document.createElement("span"),this.l.tabIndex=0,Wf(this.ka,this.l,"focus",this.kc),this.F=document.createElement("span"),this.F.tabIndex=0,Wf(this.ka,this.F,"focus",this.kc),b.parentNode&&b.parentNode.insertBefore(this.l,b),b.parentNode&&b.parentNode.insertBefore(this.F,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Xh(this))this.D="flash",this.u||Ef(a,!1,w(this.Ma,this));
else{Yh(this);this.D="flash";this.b.loaded=!0;b=this.j;b=v(b)?ke(b):b;a=We(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=zf.getInstance();Af(c,a.minVersion)?(c=Ff(a,c),Df(b,c,a)):Hf(b,a,c);this.Ma()}};
g.kc=function(){Vh(this).focus()};
function Vh(a){var b=ke(a.g);!b&&a.o&&a.o.querySelector&&(b=a.o.querySelector("#"+a.g));return b}
g.Ma=function(){if(!this.isDisposed()){var a=Vh(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.ia=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))Uh(this);else{Nh(this);this.u=!0;a=Vh(this);a.addEventListener&&(this.U=Zh(this,a,"addEventListener"));a.removeEventListener&&(this.qa=Zh(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.f[d]||(this.f[d]=Zh(this,a,d))}for(var e in this.i)this.U(e,
this.i[e]);Rh(this);this.Ga&&this.Ga(this.f);this.Z.w("onReady",this.f)}else this.Xb=H(w(this.Ma,this),50)}};
...
function Nh(a){a.u=!1;if(a.qa)for(var b in a.i)a.qa(b,a.i[b]);for(var c in a.la)I(parseInt(c,10));a.la={};a.U=null;a.qa=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=w(a.na,a);a.f.removeEventListener=w(a.be,a);a.f.destroy=w(a.dispose,a);a.f.getLastError=w(a.gd,a);a.f.getPlayerType=w(a.hd,a);a.f.getCurrentVideoConfig=w(a.fd,a);a.f.loadNewVideoConfig=w(a.Tb,a);a.f.isReady=w(a.Ae,a)}
g.Ae=function(){return this.u};
g.na=function(a,b){if(!this.isDisposed()){var c=Sh(this,b);if(c){if(!A(this.Uc,a)&&!this.i[a]){var d=$h(this,a);this.U&&this.U(a,d)}this.Z.subscribe(a,c);"onReady"==a&&this.u&&H(ma(c,this.f),0)}}};
g.be=function(a,b){if(!this.isDisposed()){var c=Sh(this,b);c&&this.Z.unsubscribe(a,c)}};
function Sh(a,b){var c=b;if("string"==typeof b){if(a.Ha[b])return a.Ha[b];c=function(){var a=r(b);a&&a.apply(l,arguments)};
a.Ha[b]=c}return c?c:null}
function $h(a,b){var c="ytPlayer"+b+a.V;a.i[b]=c;l[c]=function(c){var e=H(function(){if(!a.isDisposed()){a.Z.w(b,c);var f=a.la,h=String(e);h in f&&delete f[h]}},0);
gb(a.la,String(e))};
return c}
...
g.Bd=function(){this.Sa||(of?(this.Ra=ne(document),Wf(this.H,window,"scroll",this.Wd),Wf(this.H,this.j,"touchmove",this.Qd)):(Wf(this.H,this.j,"mousewheel",this.nc),Wf(this.H,this.j,"wheel",this.nc)),this.Sa=!0)};
g.Cd=function(){Xf(this.H);this.Sa=!1};
...
function Pi(a){var b="mouseover"==a.type&&"mouseenter"in Mi||"mouseout"==a.type&&"mouseleave"in Mi,c=a.type in Mi||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Mi[b],d;for(d in c.ca){var e=Oi(b,d,a.target);e&&!ze(a.relatedTarget,function(a){return a==e},!0)&&c.w(d,e,b,a)}}if(b=Mi[a.type])for(d in b.ca)(e=Oi(a.type,d,a.target))&&b.w(d,e,a.type,a)}}
M(document,"blur",Pi,!0);M(document,"change",Pi,!0);M(document,"click",Pi);M(document,"focus",Pi,!0);M(document,"mouseover",Pi);M(document,"mouseout",Pi);M(document,"mousedown",Pi);M(document,"keydown",Pi);M(document,"keyup",Pi);M(document,"keypress",Pi);M(document,"cut",Pi);M(document,"paste",Pi);Ni&&(M(document,"touchstart",Pi),M(document,"touchend",Pi),M(document,"touchcancel",Pi));function Qi(a){this.j=a;this.g={};this.pb=[];this.i=[]}
function R(a,b){return"yt-uix"+(a.j?"-"+a.j:"")+(b?"-"+b:"")}
Qi.prototype.unregister=function(){mc(this.pb);this.pb.length=0;ph(this.i);this.i.length=0};
...
y(Vi,Qi);ba(Vi);g=Vi.prototype;g.register=function(){Si(this,"mouseover",this.mb);Si(this,"mouseout",this.Ca);Si(this,"focus",this.ec);Si(this,"blur",this.$b);Si(this,"click",this.Ca);Si(this,"touchstart",this.Ec);Si(this,"touchend",this.sb);Si(this,"touchcancel",this.sb)};
g.unregister=function(){Ti(this,"mouseover",this.mb);Ti(this,"mouseout",this.Ca);Ti(this,"focus",this.ec);Ti(this,"blur",this.$b);Ti(this,"click",this.Ca);Ti(this,"touchstart",this.Ec);Ti(this,"touchend",this.sb);Ti(this,"touchcancel",this.sb);this.dispose();Vi.B.unregister.call(this)};
g.dispose=function(){for(var a in this.f)this.Ca(this.f[a]);this.f={}};
g.mb=function(a){if(!(this.b&&1E3>x()-this.b)){var b=parseInt(C(a,"tooltip-hide-timer"),10);b&&(Eb(a,"tooltip-hide-timer"),I(b));var b=w(function(){Wi(this,a);Eb(a,"tooltip-show-timer")},this),c=parseInt(C(a,"tooltip-show-delay"),10)||0,b=H(b,c);
...
g.Ec=function(a,b,c){c.changedTouches&&(this.b=0,a=Oi(b,R(this),c.changedTouches[0].target),this.mb(a))};
g.sb=function(a,b,c){c.changedTouches&&(this.b=x(),a=Oi(b,R(this),c.changedTouches[0].target),this.Ca(a))};
function $i(a,b){Ui(a,b);var c=C(a,"content-id");(c=ke(c))&&se(c,b)}
function Xi(a){return C(a,"tooltip-text")||a.title}
function Wi(a,b){if(b){var c=Xi(b);if(c){var d=ke(Yi(a,b));if(!d){d=document.createElement("div");d.id=Yi(a,b);d.className=R(a,"tip");var e=document.createElement("div");e.className=R(a,"tip-body");var f=document.createElement("div");f.className=R(a,"tip-arrow");var h=document.createElement("div");h.setAttribute("aria-hidden","true");h.className=R(a,"tip-content");var k=aj(a,b),m=Yi(a,b,"content");h.id=m;Cb(b,"content-id",m);e.appendChild(h);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);var n=
ve(b),m=Yi(a,b,"arialabel"),f=document.createElement("div");be(f,R(a,"arialabel"));f.id=m;n=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+n:n+" "+c;se(f,n);b.setAttribute("aria-labelledby",m);m=Li()||document.body;m.appendChild(f);m.appendChild(d);$i(b,c);(c=parseInt(C(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",be(h,R(a,"normal-wrap")));h=ae(b,R(a,"reverse"));bj(a,b,d,e,k,h)||bj(a,b,d,e,k,!h);var Z=R(a,"tip-visible");
H(function(){be(d,Z)},0)}}}}
...
g.Ia=function(a,b,c){var d=gj(this,a),d=Ra([d],Va(arguments,1));this.Xc.apply(this,d)};
...
function ok(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,ba:ma(a.o,d,!0),onError:ma(a.j,e),Da:ma(a.l,e)};c&&(a.S=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Od(b,a)}
...
y(uk,U);uk.prototype.W=function(){return this.screens};
...
g.xc=function(){this.f=NaN;this.b=Od(nk(this.u,"/pairing/get_screen"),{method:"POST",S:{pairing_code:this.l},timeout:5E3,ba:w(this.se,this),onError:w(this.re,this),Da:w(this.te,this)})};
...
g.xb=function(a,b){Rk(this);vk(this,a);Tk(this,!1);this.w("screenChange");b(a);a.token||Sk(this)};
g.remove=function(a,b){var c=Rk(this);xk(this,a)&&(Tk(this,!1),c=!0);b(a);c&&this.w("screenChange")};
g.ub=function(a,b,c,d){var e=Rk(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,Tk(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.w("screenChange")};
...
g.ub=function(a,b,c,d){this.f.contains(a)?this.f.ub(a,b,c,d):(a="Updating name of unknown screen: "+a.name,bk(this.l,a),d(Error(a)))};
...
function bl(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);c||(c=a.i[b]);var h=a.W();if(h=(c?tk(h,c):null)||tk(h,b)){h.uuid=b;var k=cl(a,h);Yk(a.b,k,function(a){e(a?k:null)})}else c?dl(a,c,w(function(a){var f=cl(this,new ek({name:d,
...
g.ve=function(a,b,c,d){Od(nk(this.j,"/pairing/get_screen"),{method:"POST",S:{pairing_code:a},timeout:5E3,ba:w(function(a,d){var h=new ek(d.screen||{});if(!h.name||el(this,h.name)){var k;a:{k=h.name;for(var m=2,n=b(k,m);el(this,n);){m++;if(20<m)break a;n=b(k,m)}k=n}h.name=k}c(cl(this,h))},this),
...
function dl(a,b,c,d){a.info("requestLoungeToken_ for "+b);var e={S:{screen_ids:b},method:"POST",context:a,ba:function(a,e){var k=e&&e.screens||[];k[0]&&k[0].screenId==b?c(k[0].loungeToken):d(Error("Missing lounge token in token response"))},
onError:function(){d(Error("Request screen lounge token failed"))}};
Od(nk(a.j,"/pairing/get_lounge_token_batch"),e)}
function fl(a){a.screens=a.f.W();var b=a.i,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+kk(a.screens))}
g.md=function(){fl(this);this.w("screenChange");this.b.update()};
function al(a){gl(a);a.f=new Qk(a.j);a.f.subscribe("screenChange",w(a.md,a));fl(a);a.g=ik(T("yt-remote-automatic-screen-cache")||[]);gl(a);a.info("Initializing automatic screens: "+kk(a.g));a.b=new Uk(a.j,w(a.W,a,!0));a.b.subscribe("screenChange",w(function(){this.w("onlineScreenChange")},a))}
...
y(hl,U);g=hl.prototype;g.ob=function(a){this.g=a;this.w("sessionScreen",this.g)};
g.X=function(a){this.isDisposed()||(a&&il(this,""+a),this.g=null,this.w("sessionScreen",null))};
...
g.La=function(a){this.info("launchWithParams: "+L(a));this.i=a;this.b&&ll(this)};
...
function kl(a,b){I(a.j);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.g||a.g.id!=b){var c=w(a.ob,a),d=w(a.X,a);a.gc(b,c,d,5)}}else a.X(Error("Waiting for session status timed out."))}
...
g.we=function(a){this.isDisposed()||a||(il(this,"Cast session died."),this.X())};function nl(a,b){hl.call(this,a,b,"DialSession");this.i=this.D=null;this.H="";this.j=null;this.u=t;this.l=NaN;this.K=w(this.ze,this);this.b=t}
y(nl,hl);g=nl.prototype;g.Pb=function(a){this.i=a;this.i.addUpdateListener(this.K)};
g.La=function(a){this.j=a;this.u()};
...
function ol(a){a.b=a.F.Hc(a.H,a.f.label,a.f.friendlyName,w(function(a){this.b=t;this.ob(a)},a),w(function(a){this.b=t;
this.X(a)},a))}
g.ze=function(a){this.isDisposed()||a||(il(this,"DIAL session died."),this.b(),this.b=t,this.X())};
...
g.nd=function(a,b){bl(this.F,this.D.receiver.label,a,this.f.friendlyName,w(function(a){a&&a.token?(this.ob(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Lb(b)},this),w(function(a){il(this,"Failed to get DIAL screen: "+a);
this.Lb(b)},this))};function ql(a,b){hl.call(this,a,b,"ManualSession");this.b=H(w(this.La,this,null),150)}
y(ql,hl);ql.prototype.stop=function(){this.X()};
ql.prototype.Pb=t;ql.prototype.La=function(){I(this.b);this.b=NaN;var a=tk(this.F.W(),this.f.label);a?this.ob(a):this.X(Error("No such screen"))};
...
function vl(a,b,c){E(a.b);(a.b=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.f):a.w("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",w(a.sc,a,b)),b.g?a.w("yt-remote-cast2-session-change",b.g):c&&a.b.La(null)):a.w("yt-remote-cast2-session-change",null)}
...
g.A=function(){tm.B.A.call(this);if(this.g){var a=this.g,b=0,c;for(c in a.b){for(var d=a.b[c],e=0;e<d.length;e++)++b,$l(d[e]);delete a.b[c];a.f--}}this.Z=null};
...
g=Lm.prototype;g.Aa=null;g.fa=!1;g.Qa=null;g.Sb=null;g.bb=null;g.Pa=null;g.ra=null;g.ua=null;g.Ea=null;g.J=null;g.eb=0;g.ga=null;g.wb=null;g.Ba=null;g.Za=-1;g.Ac=!0;g.wa=!1;g.Jb=0;g.qb=null;var Mm={},Nm={};g=Lm.prototype;g.setTimeout=function(a){this.j=a};
function Om(a,b,c){a.Pa=1;a.ra=Ug(b.clone());a.Ea=c;a.o=!0;Pm(a,null)}
function Qm(a,b,c,d,e){a.Pa=1;a.ra=Ug(b.clone());a.Ea=null;a.o=c;e&&(a.Ac=!1);Pm(a,d)}
function Pm(a,b){a.bb=x();Rm(a);a.ua=a.ra.clone();Sg(a.ua,"t",a.l);a.eb=0;a.J=a.b.Cb(a.b.cb()?b:null);0<a.Jb&&(a.qb=new Am(w(a.Fc,a,a.J),a.Jb));a.i.lb(a.J,"readystatechange",a.$d);var c=a.Aa?hb(a.Aa):{};a.Ea?(a.wb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.J.send(a.ua,a.wb,a.Ea,c)):(a.wb="GET",a.Ac&&!$c&&(c.Connection="close"),a.J.send(a.ua,a.wb,null,c));a.b.ea(1)}
...
g=gn.prototype;g.Hb=null;g.Y=null;g.rb=!1;g.Dc=null;g.hb=null;g.Mb=null;g.Ib=null;g.aa=null;g.pa=-1;g.Ya=null;g.Ua=null;g.connect=function(a){this.Ib=a;a=hn(this.b,null,this.Ib);X();this.Dc=x();var b=this.b.u;null!=b?(this.Ya=b[0],(this.Ua=b[1])?(this.aa=1,jn(this)):(this.aa=2,kn(this))):(Sg(a,"MODE","init"),this.Y=new Lm(this,0,void 0,void 0,void 0),this.Y.Aa=this.Hb,Qm(this.Y,a,!1,null,!0),this.aa=0)};
function jn(a){var b=hn(a.b,a.Ua,"/mail/images/cleardot.gif");Ug(b);dn(b.toString(),5E3,w(a.$c,a),3,2E3);a.ea(1)}
g.$c=function(a){if(a)this.aa=2,kn(this);else{X();var b=this.b;b.da=b.sa.pa;ln(b,9)}a&&this.ea(2)};
function kn(a){var b=a.b.N;if(null!=b)X(),b?(X(),mn(a.b,a,!1)):(X(),mn(a.b,a,!0));else if(a.Y=new Lm(a,0,void 0,void 0,void 0),a.Y.Aa=a.Hb,b=a.b,b=hn(b,b.cb()?a.Ya:null,a.Ib),X(),!K||kd(10))Sg(b,"TYPE","xmlhttp"),Qm(a.Y,b,!1,a.Ya,!1);else{Sg(b,"TYPE","html");var c=a.Y;a=!!a.Ya;c.Pa=3;c.ra=Ug(b.clone());$m(c,a)}}
...
g.ea=function(a){this.b.ea(a)};function nn(a){tm.call(this);this.headers=new Ic;this.L=a||null;this.f=!1;this.K=this.b=null;this.ka=this.D="";this.j=0;this.o="";this.i=this.V=this.u=this.U=!1;this.l=0;this.F=null;this.la="";this.H=this.ia=!1}
...
g.oc=function(){this.isDisposed()||(this.V||this.u||this.i?xn(this):this.Hd())};
...
g=yn.prototype;g.Wa=null;g.T=null;g.G=null;g.Gb=null;g.ib=null;g.Zb=null;g.jb=null;g.$a=0;g.sd=0;g.M=null;g.ta=null;g.oa=null;g.ya=null;g.sa=null;g.vb=null;g.Ka=-1;g.jc=-1;g.da=-1;g.Xa=0;g.Ja=0;g.xa=8;var An=new tm;function Bn(a){Tl.call(this,"statevent",a)}
...
function En(a){Fn(a);if(3==a.b){var b=a.$a++,c=a.ib.clone();N(c,"SID",a.g);N(c,"RID",b);N(c,"TYPE","terminate");Gn(a,c);b=new Lm(a,0,a.g,b,void 0);b.Pa=2;b.ra=Ug(c.clone());(new Image).src=b.ra;b.bb=x();Rm(b)}Hn(a)}
...
function Nn(a,b){var c,d;b?6<a.xa?(a.f=a.i.concat(a.f),a.i.length=0,c=a.$a-1,d=Mn(a)):(c=b.u,d=b.Ea):(c=a.$a++,d=Mn(a));var e=a.ib.clone();N(e,"SID",a.g);N(e,"RID",c);N(e,"AID",a.Ka);Gn(a,e);c=new Lm(a,0,a.g,c,a.Xa+1);c.Aa=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.T=c;Om(c,e,d)}
...
return c.join("&")}
function On(a){a.G||a.oa||(a.o=1,a.oa=an(w(a.tc,a),0),a.Ja=0)}
function Pn(a){if(a.G||a.oa||3<=a.Ja)return!1;a.o++;a.oa=an(w(a.tc,a),Qn(a,a.Ja));a.Ja++;return!0}
g.tc=function(){this.oa=null;this.G=new Lm(this,0,this.g,"rpc",this.o);this.G.Aa=null;this.G.Jb=0;var a=this.Zb.clone();N(a,"RID","rpc");N(a,"SID",this.g);N(a,"CI",this.vb?"0":"1");N(a,"AID",this.Ka);Gn(this,a);if(!K||kd(10))N(a,"TYPE","xmlhttp"),Qm(this.G,a,!0,this.jb,!1);else{N(a,"TYPE","html");var b=this.G,c=!!this.jb;b.Pa=3;b.ra=Ug(a.clone());$m(b,c)}};
function mn(a,b,c){a.vb=c;a.da=b.pa;a.cd(1,0);a.ib=hn(a,null,a.Gb);Kn(a)}
g.pc=function(a,b){if(0!=this.b&&(this.G==a||this.T==a))if(this.da=a.Za,this.T==a&&3==this.b)if(7<this.xa){var c;try{c=this.j.parse(b)}catch(f){c=null}if(u(c)&&3==c.length)if(0==c[0])a:{if(!this.oa){if(this.G)if(this.G.bb+3E3<this.T.bb)In(this),this.G.cancel(),this.G=null;else break a;Pn(this);X()}}else this.jc=c[1],0<this.jc-this.Ka&&37500>c[2]&&this.vb&&0==this.Ja&&!this.ya&&(this.ya=an(w(this.td,this),6E3));else ln(this,11)}else"y2f%"!=b&&ln(this,11);else if(this.G==a&&In(this),!/^[\s\xa0]*$/.test(b)){c=
this.j.parse(b);u(c);for(var d=0;d<c.length;d++){var e=c[d];this.Ka=e[0];e=e[1];2==this.b?"c"==e[0]?(this.g=e[1],this.jb=e[2],e=e[3],null!=e?this.xa=e:this.xa=6,this.b=3,this.M&&this.M.dc(this),this.Zb=hn(this,this.cb()?this.jb:null,this.Gb),On(this)):"stop"==e[0]&&ln(this,7):3==this.b&&("stop"==e[0]?ln(this,7):"noop"!=e[0]&&this.M&&this.M.cc(this,e),this.Ja=0)}}};
...
g.nb=function(a){var b;if(this.G==a)In(this),this.G=null,b=2;else if(this.T==a)this.T=null,b=1;else return;this.da=a.Za;if(0!=this.b)if(a.fa)1==b?(x(),um(An,new Cn(An,a.Ea?a.Ea.length:0)),Kn(this),this.i.length=0):On(this);else{var c=a.Ba,d;if(!(d=3==c||7==c||0==c&&0<this.da)){if(d=1==b)this.T||this.ta||1==this.b||2<=this.Xa?d=!1:(this.ta=an(w(this.uc,this,a),Qn(this,this.Xa)),this.Xa++,d=!0);d=!(d||2==b&&Pn(this))}if(d)switch(c){case 1:ln(this,5);break;case 4:ln(this,10);break;case 3:ln(this,6);
...
function hn(a,b,c){var d=Vg(c);if(""!=d.f)b&&Gg(d,b+"."+d.f),Hg(d,d.l);else var e=window.location,d=Wg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.Wa&&Xa(a.Wa,function(a,b){N(d,b,a)});
...
function Xn(a){return{firstTestResults:[""],secondTestResults:!a.b.vb,sessionId:a.b.g,arrayId:a.b.Ka}}
...
$n.prototype.clone=function(){return new $n(co(this))};function Y(a,b,c){U.call(this);this.i=NaN;this.U=!1;this.H=this.F=this.K=this.L=NaN;this.V=[];this.u=this.D=this.g=this.C=this.b=null;this.Sa=a;this.V.push(M(window,"beforeunload",w(this.jd,this)));this.f=[];this.C=new $n;this.ia=b.id;this.b=eo(this,c);this.b.subscribe("handlerOpened",this.xd,this);this.b.subscribe("handlerClosed",this.ud,this);this.b.subscribe("handlerError",this.vd,this);this.b.subscribe("handlerMessage",this.wd,this);Zn(this.b,b.token);this.subscribe("remoteQueueChange",function(){var a=
this.C.videoId;Fk()&&S("yt-remote-session-video-id",a)},this)}
y(Y,U);g=Y.prototype;g.connect=function(a,b){if(b){var c=b.listId,d=b.videoId,e=b.index,f=b.currentTime||0;5>=f&&(f=0);var h={videoId:d,currentTime:f};c&&(h.listId=c);p(e)&&(h.currentIndex=e);c&&(this.C.f=c);this.C.videoId=d;this.C.index=e||0;this.C.state=3;c=this.C;c.g=f;c.j=x();this.u="UNSUPPORTED";fo("Connecting with setPlaylist and params: "+L(h));this.b.connect({method:"setPlaylist",params:L(h)},a,Jk())}else fo("Connecting without params"),this.b.connect({},a,Jk());go(this)};
g.dispose=function(){this.isDisposed()||(this.w("beforeDispose"),ho(this,3));Y.B.dispose.call(this)};
g.A=function(){io(this);jo(this);ko(this);I(this.F);this.F=NaN;I(this.H);this.H=NaN;this.g=null;He(this.V);this.V.length=0;this.b.dispose();Y.B.A.call(this);this.u=this.D=this.f=this.C=this.b=null};
function fo(a){bk("conn",a)}
g.jd=function(){this.j(2)};
function eo(a,b){return new Vn(nk(a.Sa,"/bc",void 0,!1),b)}
...
Nk(Xn(this.b),this.ia)};
g.ud=function(){fo("Channel closed");isNaN(this.i)?Ok(!0):Ok();this.dispose()};
g.vd=function(a){Ok();isNaN(this.l())?(fo("Channel error: "+a+" without reconnection"),this.dispose()):(this.U=!0,fo("Channel error: "+a+" with reconnection in "+this.l()+" ms"),ho(this,2))};
...
break;case "gracefulDisconnect":break;case "playlistModified":qo(this,a);break;case "nowPlaying":ro(this,a);break;case "onStateChange":so(this,a);break;case "onVolumeChanged":to(this,a);break;case "onSubtitlesTrackChanged":po(this,a);break;case "nowAutoplaying":this.D=a.params.videoId;break;case "autoplayDismissed":break;case "autoplayUpNext":this.D=a.params.videoId;break;case "onAutoplayModeChanged":this.u=a.params.autoplayMode;break;default:fo("Unrecognized action: "+a.action)}};
g.ce=function(){if(this.g){var a=this.g;this.g=null;this.C.videoId!=a&&mo(this,"getNowPlaying")}};
Y.prototype.subscribe=Y.prototype.subscribe;Y.prototype.unsubscribeByKey=Y.prototype.ha;Y.prototype.Ga=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.l())?Yn(this.b)&&isNaN(this.i)&&(a=1):a=2);return a};
Y.prototype.getProxyState=Y.prototype.Ga;Y.prototype.j=function(a){fo("Disconnecting with "+a);io(this);this.w("beforeDisconnect",a);1==a&&Ok();Wn(this.b,a);this.dispose()};
...
Y.prototype.Ha=function(a,b){mo(this,a,b);oo(this)};
Y.prototype.sendMessage=Y.prototype.Ha;function uo(a){uk.call(this,"ScreenServiceProxy");this.R=a;this.b=[];this.b.push(this.R.$_s("screenChange",w(this.ue,this)));this.b.push(this.R.$_s("onlineScreenChange",w(this.Dd,this)))}
y(uo,uk);g=uo.prototype;g.W=function(a){return this.R.$_gs(a)};
...
V.prototype.$_st=V.prototype.start;V.prototype.$_gspc=V.prototype.ve;V.prototype.$_gsppc=V.prototype.Hc;V.prototype.$_c=V.prototype.contains;V.prototype.$_g=V.prototype.get;V.prototype.$_a=V.prototype.xb;V.prototype.$_un=V.prototype.ub;V.prototype.$_r=V.prototype.remove;V.prototype.$_gs=V.prototype.W;V.prototype.$_gos=V.prototype.Gc;V.prototype.$_s=V.prototype.subscribe;V.prototype.$_ubk=V.prototype.ha;function vo(){var a={device:"Desktop",app:"youtube-desktop"};yj&&xj();Ck();wo||(wo=new mk,Pk()&&(wo.b="/api/loungedev"));xo||(xo=r("yt.mdx.remote.deferredProxies_")||[],q("yt.mdx.remote.deferredProxies_",xo,void 0));yo();var b=zo();if(!b){var c=new V(wo);q("yt.mdx.remote.screenService_",c,void 0);b=zo();wl(c,function(a){a?Ao()&&Pl(Ao(),"YouTube TV"):c.subscribe("onlineScreenChange",function(){J("yt-remote-receiver-availability-change")})},!(!a||!a.loadCastApiSetupScript))}if(a&&!r("yt.mdx.remote.initialized_")){q("yt.mdx.remote.initialized_",
!0,void 0);
...
function Po(){var a=Ao();if(!a)return null;var b=zo().W();return tk(b,a)}
function Eo(a){Bo("remote.onCastSessionChange_: "+jk(a));if(a){var b=Po();b&&b.id==a.id?Pl(b.id,"YouTube TV"):(b&&So(),To(a,1))}else So()}
function Uo(a,b){Bo("Connecting to: "+L(a));if("cast-selector-receiver"==a.key)Do(b||null),Ol(b||null);else{So();Do(b||null);var c=zo().W();(c=tk(c,a.key))?To(c,1):H(function(){Vo(null)},0)}}
...
function Fo(){var a=Fk();if(!a)return null;var b=zo().W();return tk(b,a)}
...
function Gp(a,b){H(function(){var a=w(Hp,l,b),a=Ap().then(Ep,a);gg(a,null,t,void 0)},a)}
...
function Zp(a,b,c,d){var e=new pi(a);Q(yi,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=G("PLAYBACK_ID"))&&(c.plid=d);(d=G("EVENT_ID"))&&(c.ei=d);b&&mq(b,c);Od("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Rb:f,S:c,ba:function(b,c){var d=c.response;Q(Ai,new si(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&J("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Jp(d.actions)},
Nb:function(){Q(zi,e)}})}
function aq(a,b,c,d,e){var f=new pi(a);Q(Di,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=G("PLAYBACK_ID"))&&(d.plid=a);(a=G("EVENT_ID"))&&(d.ei=a);c&&mq(c,d);Od("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Rb:h,S:d,ba:function(a,b){var c=b.response;Q(Fi,f);c.actions&&Jp(c.actions)},
Nb:function(){Q(Ei,f)}})}
...
Od("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",S:c,ba:function(c,f){d();var h=f.response,k=h.id;if(u(k)&&k.length==b.length){var m=h.channel_info_map;z(k,function(a,c){var d=b[c];Q(Ai,new si(d,a,m[d]))});
...
Od("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",S:c,ba:function(){d();lq(b,Fi);a.length&&eq(a)},
onError:function(){d()}})}}
